...
- [Thoughtbot Trail Map](https://github.com/thoughtbot/trail-map/blob/master/rails.md)
...
[A Web Server vs. An App Server](http://www.justinweiss.com/2015/07/15/a-web-server-vs-an-app-server/)